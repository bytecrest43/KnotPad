            ...
            <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
              ...
              >
                <Image
                  ...
                  priority
                />
                <span className="text-2xl font-bold">KnotPad</span>
              </Link>
              ...
              >
                <Menu
                  data-state={!menuState ? "active" : "inactive"}
                  className="in-data-[state=active]:rotate-0 in-data-[state=active]:scale-100 in-data-[state=active]:opacity-100 m-auto size-6 duration-200"
                />
                <X
                  data-state={menuState ? "active" : "inactive"}
